...
import static com.myapp.iib.model.BrokerPropertiesModel.*;

@PageTitle("Node Properties")
@Route(value = "nodeProperties", layout = MainLayout.class)
public class BrokerProperties extends ViewFrame {
    ...
    public void load() {
        ...
        wrapperBox.addAll(FlowUtilsWrapper.discoverBrkProperties(flowUtils.brokerProxy()));
        listing.refresh();
    ...
    private Component createListing() {
        ...
        listing = Components.listing.properties(SNO, NODE_NAME, NODE_TYPE)
