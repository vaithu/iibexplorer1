...
@PageTitle("EG Componenets")
@Route(value = "EGComponents", layout = MainLayout.class)
public class EGComponents extends ViewFrame {
    ...
    private Component createListing() {
        ...
        listing = Components.listing.properties(SNO,EG_NAME,PID,NAME,DEPLOYED_TIME)
                ...
                .itemDetailsComponent(propertyBox -> {
                    PropertyInputForm inputForm = Components.input.form( PARENT_NAME,PARENT_TYPE, BAR_FILE)
                            .initializer(layout -> {
                                layout.setSizeFull();
