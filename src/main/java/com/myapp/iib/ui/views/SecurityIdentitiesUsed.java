...
import static com.myapp.iib.model.SecurityIdentitiesModel.*;

@PageTitle("Security Identities Used")
@Route(value = "securityidentities", layout = MainLayout.class)
public class SecurityIdentitiesUsed extends ViewFrame {
    ...
    public void load() {
        ...
        wrapperBox.addAll(FlowUtilsWrapper.securityIdentities(flowUtils.brokerProxy()));
        listing.refresh();
