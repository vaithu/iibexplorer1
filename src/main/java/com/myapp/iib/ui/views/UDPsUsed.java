...
import static com.myapp.iib.model.UDPsUsedModel.*;

@PageTitle("UDPs Used")
@Route(value = "udps", layout = MainLayout.class)
public class UDPsUsed extends ViewFrame {
    ...
    public void load() {
        ...
        wrapperBox.addAll(FlowUtilsWrapper.udpsUsedListing(flowUtils.allMFs()));
        listing.refresh();
    ...
    private Component createListing() {
        ...
        dataProvider.addFilter(propertyBox -> MyUtils.addFilter(searchField, propertyBox,
                NAME, UDPsUsedModel.UDP_NAME, UDPsUsedModel.UDP_PROP,EG_NAME,PARENT_NAME)
