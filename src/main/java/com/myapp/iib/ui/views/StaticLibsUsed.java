...
@PageTitle("Static Libraries Used")
@Route(value = "Staticlibs", layout = MainLayout.class)
public class StaticLibsUsed extends ViewFrame {
    ...
    public void load() {
        ...
        wrapperBox.addAll(FlowUtilsWrapper.staticLibsUsedListing(flowUtils.allStaticLibs()).collect(Collectors.toList()));
        listing.refresh();
